...
### 2. Cargo 文件夹中，新增一个结构体怎么放？

**文件夹现状：**

```txr
lab1/lab1.1/   
  ├── REDEME.md                                                                             └── manifest-parser/                                                                           ├── Cargo.toml                                                                             ├── Cargo.lock                                                                             ├── src/                                                                                   │   └── main.rs                                                                           └── target/           ← 编译产物（已 gitignore）       
```
